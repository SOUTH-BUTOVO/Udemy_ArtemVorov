...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] massR = {-5, 0, 1, 1, 2, 3, 4, 7, 10, 12, 13, 15};
        int left = 0;
        int right = massR.length - 1;
        int valueToFindR = 15;
        System.out.println((binaryRecursive.searchBinaryRecursive(massR, left, right, valueToFindR) < 0) ?
                ("Искомое число " + valueToFindR + ", не найдено.") : ("Число " + valueToFindR + ", найдено."));
        System.out.println("-----------");
        ...
        identicalWords.dictionaryWords();
    }
}
